...
- instead of using long commands, use [`distrobox assemble` command](#assemble) with manifest file
- to upgrade the containers' packages, use [`distrobox upgrade` command](#upgrade)
...
- create easily discartible and reproducible containers
